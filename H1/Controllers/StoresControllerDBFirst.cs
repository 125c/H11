...
{
    public class StoresController1 : Controller
    {
        private HerLin0030EntitiesStore db = new HerLin0030EntitiesStore();
        SetData sd = new SetData();

        public SqlDbType StoreLocation { get; private set; }
        ...
        // GET: Stores/Create
        [HttpPost]
        public ActionResult Create(String StoreIdentify, String StoreAddress,double? StoreLocationX, double? StoreLocationY, double? StoreLocation, String StoreTelephone, bool StorePay, String StoreText, String StoreIdentifyChain, String StoreIdentifyChineseName)
        {
            List<SqlParameter> list = new List<SqlParameter>
            {
                ...
                new SqlParameter("StoreLocation",StoreLocation),
            ...
            string sql = "insert into Store values(@StoreIdentify,@StoreAddress,@StoreLocationX,@StoreLocationY,@StoreLocation,@StoreTelephone,@StorePay,@StoreText,@StoreIdentifyChain,@StoreIdentifyChineseName)";
